...
<style>
/* master */
.shop003-banner-bottom {position:relative}
/* 컨트롤 */
...
.shop003-banner-bottom .item a > div {height:90px;background-size:cover;background-repeat:no-repeat;background-position:center}
