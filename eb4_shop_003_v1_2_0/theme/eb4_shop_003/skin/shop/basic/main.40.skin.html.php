...
.product-main-40 .item-main-40-in {position:relative;margin-bottom:20px;border:1px solid #eee;-webkit-transition:all 0.3s ease-in-out;-moz-transition:all 0.3s ease-in-out;-o-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.product-main-40 .item-main-40-in:hover {border-color:#F2A23A}
.product-main-40 .product-img-wrap {position:relative;background:#fff}
...
/* 소셜링크 */
.product-main-40 .product-img .product-sns {position:absolute;top:10px;right:-40px;z-index:1;-webkit-transition:all 0.3s ease-in-out;-moz-transition:all 0.3s ease-in-out;-o-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.product-main-40 .item-main-50:hover .product-img .product-sns {right:10px}
...
/* 상품 정보 */
.product-main-40 .product-description .product-description-in {position:relative;bottom:0;overflow:hidden;padding:10px;background:#fff;-webkit-transition:all 0.3s ease-in-out;-moz-transition:all 0.3s ease-in-out;-o-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.product-main-40 .item-main-40-in:hover .product-description .product-description-in {bottom:10px}
.product-main-40 .product-description .product-name {position:relative;overflow:hidden;margin:10px 0 5px;height:40px}
.product-main-40 .product-description .product-name a {display:block;line-height:20px;font-size:15px;color:#000}
