...
.product-main-30 .item-main-30 {position:relative;margin-bottom:20px;border:1px solid #eee;-webkit-transition:all 0.3s ease-in-out;-moz-transition:all 0.3s ease-in-out;-o-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.product-main-30 .item-main-30:hover {border-color:#F2A23A}
.product-main-30 .product-img-wrap {position:relative;background:#fff}
...
/* 상품 정보 */
.product-main-30 .product-description .product-description-in {position:relative;bottom:0;overflow:hidden;padding:10px;background:#fff;-webkit-transition:all 0.3s ease-in-out;-moz-transition:all 0.3s ease-in-out;-o-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.product-main-30 .item-main-30:hover .product-description .product-description-in {bottom:10px}
.product-main-30 .product-description .product-name {position:relative;overflow:hidden;margin:10px 0 5px;height:40px}
.product-main-30 .product-description .product-name a {display:block;line-height:20px;font-size:15px;color:#000}
...
@media (max-width:767px) {
    .product-main-30.row {margin-left:-5px;margin-right:-5px}
    .product-main-30 .col-sm-3 {width:50%;float:left;padding-left:5px;padding-right:5px}
    .product-main-30 .item-main-30 {margin-bottom:10px}
