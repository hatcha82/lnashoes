...
/* 최신글 타이틀 */
.gallery-latest {}
.gallery-latest .latest-title {position:relative;margin:0 0 30px;padding-bottom:15px;border-bottom:3px solid #eee}
.gallery-latest .latest-title:before {content:"";position:absolute;bottom:-3px;left:0;width:20px;height:3px;background:#F2A23A}
.gallery-latest .latest-title h2 {margin:0;font-size:30px;line-height:40px;font-weight:100}
/* 아이템 - 이미지와 내용 */
...
@media (max-width:991px){
    .gallery-latest .latest-title {margin-bottom:30px}
    .gallery-wrap .gallery-image .img-box {height:230px}
}
@media (max-width:767px){
    .gallery-latest .latest-title h2 {font-size:20px;line-height:30px}
