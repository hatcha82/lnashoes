...
.product-main-20 .item-main-20-in {position:relative;border:1px solid #eee;background:#fff;margin-bottom:20px;-webkit-transition:all 0.3s ease-in-out;-moz-transition:all 0.3s ease-in-out;-o-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.product-main-20 .item-main-20-in:hover {border-color:#F2A23A}
/* 이미지 */
...
/* 상품정보 */
.product-main-20 .product-description .product-description-in {position:relative;bottom:0;overflow:hidden;padding:0 10px 10px;background:#fff;-webkit-transition:all 0.3s ease-in-out;-moz-transition:all 0.3s ease-in-out;-o-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.product-main-20 .item-main-20-in:hover .product-description .product-description-in {bottom:10px}
.product-main-20 .product-description .product-name {position:relative;overflow:hidden;margin:10px 0 5px;height:40px}
.product-main-20 .product-description .product-name a {display:block;line-height:20px;font-size:15px;color:#000}
